...
The following example deletes all documents from a specified `OpenSearchIndex`, where a `timestamp` field from the index is older than or equal to 5 days from now:
